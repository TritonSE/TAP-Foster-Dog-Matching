    ...
    <div className="status-card">
      ...
      <div className="information-grid">
        <div className="box-ambassador">
          <div className="ambassador-left">Foster Name:</div>
        </div>
        <div className="box-ambassador">
          <img className="pfp smaller" src={props.image} alt="" />
        ...
        <div className="box-location">TAP Address:</div>
